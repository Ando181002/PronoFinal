    ...
    @section('contenu')
          <div class="card">
            <div class="card-body">
              ...
              <table class="table" style="margin-top: 20px;">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>              
                        <!-- Basic Modal -->
                        <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#basicModal{{$type->idphase}}">
                        <i class="ri-edit-box-fill"></i>
                        </button>
                        <div class="modal fade" id="basicModal{{$type->idphase}}" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Modifier phase de jeu</h5>
              ...
              <a type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#verticalycentered{{$type->idphase}}">
              ...
              <div class="modal fade" id="verticalycentered" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Ajouter phase de jeu</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
               <!-- General Form Elements -->
               <form class="row g-3" method="post" action="/addPhaseJeu">
                @csrf
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Phase</label>
                  <input type="text" class="form-control" id="inputNanme4" name="nomphase">
                </div>
                <div class="text-center">
