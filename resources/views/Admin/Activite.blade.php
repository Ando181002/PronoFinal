            ...
            <div class="card-body">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="row g-3" method="POST" action="updateActivite/{{$type->idactivite}}">
                                          @csrf
                                            <div class="col-12">
              ...
              <div class="modal fade" id="verticalycentered{{$type->idactivite}}" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <form methodd="POST" action="deleteactivite/{{$type->idactivite}}">
                    <div class="modal-body">
               ...
               <form class="row g-3" method="POST" action="addActivite">
                ...
                <div class="col-12">
                  ...
                  <select name="idtypeactivite" class="form-control" >
                    @foreach ($typeActivites as $typee)
