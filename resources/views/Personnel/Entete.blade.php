    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          <a href="login" type="button" class="btn btn-primary" style="background-color: orange">
                Se connecter
          </a><!-- End Messages Icon -->
        </li><!-- End Messages Nav -->
        <li class="nav-item dropdown">
          <a href="creerCompte" type="button" class="btn btn-primary" style="background-color: orange">
                S'inscrire
          </a><!-- End Messages Icon -->
        </li><!-- End Messages Nav -->
        @else
